<main>
  <div class="h-screen bg-white flex flex-col space-y-5 justify-center items-center">
 
   <div class=" flex w-96 ">
      <svg class="w-32  " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 84 21" preserveAspectRatio="xMinYMin meet" version="1.1" focusable="false">
    ...
    <div class="bg-white w-96 shadow-xl rounded p-5">
      ...
      <form class="space-y-5 mt-5">
        <input type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="E-mail or Phone" />
       <div class="w-full flex items-center  border border-gray-800 rounded px-3">
          ...
          <span class="text-blue-700 hover:bg-blue-400 rounded-full px-3 ">Show</span>
        </div>
  
        <div class="">
                    <a href="#!" class="font-medium text-blue-700 hover:bg-blue-300 rounded-full p-2">Forget Password</a>
        </div>
  
        <button class="text-center w-full bg-blue-700 rounded-full text-white py-3 font-medium">Sign In</button>
  
      </form>
    </div>
  
    <p>New to LinkedIn ? <a href="#!" class="text-blue-700 font-medium">Sign Up </a>Here.  </p>
  </div>
